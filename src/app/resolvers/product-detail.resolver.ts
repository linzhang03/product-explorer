...
import { Resolve, ActivatedRouteSnapshot, Router, RedirectCommand } from '@angular/router';
...
export class ProductDetailResolver implements Resolve<ProductWithRelated | null> {
    ...
    resolve(route: ActivatedRouteSnapshot): Observable<ProductWithRelated | RedirectCommand | null> {
